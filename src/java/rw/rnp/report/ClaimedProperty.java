...
public class ClaimedProperty extends HttpServlet {
...
//          document.add(UNDERLINE);
            ...
            Paragraph message = new Paragraph(new Chunk("Claimed Property Report ", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD)));
//          document.add(new Paragraph("\n\n"));
...
//          title.add(UNDERLINE);
            ...
            tablee5.addElement(new Phrase(new Chunk("EVIDENCES", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD))));
...
//            InputStream pdfImage;
            ...
            ResultSet rs = st.executeQuery("select* from identifies");
            while (rs.next()) {
        ...
        try {
            ...
            String strSql = "select propertyPicture from properties where propertyID='" + propertyID + "' AND propertyStatus = 'Seized' ";
            rs1 = stmt.executeQuery(strSql);
            if (rs1.next()) {

                 Blob blob = rs1.getBlob("propertyPicture");
            ...
            e.printStackTrace();
                ...
                table5.addElement(new Phrase(new Chunk("" + description + "", FontFactory.getFont(FontFactory.HELVETICA, 8))));
