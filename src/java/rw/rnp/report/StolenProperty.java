...
public class StolenProperty extends HttpServlet {
...
//          document.add(UNDERLINE);
            ...
            Paragraph message = new Paragraph(new Chunk("Seized Property Report ", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD)));
//          document.add(new Paragraph("\n\n"));
...
//            InputStream pdfImage;
            ...
            ResultSet rs = st.executeQuery("select* from properties where propertyStatus = 'Seized'");
            while (rs.next()) {
