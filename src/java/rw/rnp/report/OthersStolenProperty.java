...
public class OthersStolenProperty extends HttpServlet {
...
//          document.add(UNDERLINE);
            ...
            Paragraph message = new Paragraph(new Chunk("Others Seized Property Report ", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD)));
//          document.add(new Paragraph("\n\n"));
...
//            InputStream pdfImage;
            ...
            ResultSet rs = st.executeQuery("select* from properties where propertyStatus = 'Seized' AND categoryID = '7'");
            while (rs.next()) {
