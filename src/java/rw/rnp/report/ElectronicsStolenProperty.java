...
public class ElectronicsStolenProperty extends HttpServlet {
...
//          document.add(UNDERLINE);
            ...
            Paragraph message = new Paragraph(new Chunk("Electronics Seized Property Report ", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD)));
//          document.add(new Paragraph("\n\n"));
...
//            InputStream pdfImage;
            ...
            ResultSet rs = st.executeQuery("select* from properties where propertyStatus = 'Seized' AND categoryID = '1'");
            while (rs.next()) {
