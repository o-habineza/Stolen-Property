...
public class VehiclesReportedProperty extends HttpServlet {
...
//          document.add(UNDERLINE);
            ...
            Paragraph message = new Paragraph(new Chunk("Vehicles Reported Property Report ", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD)));
//          document.add(new Paragraph("\n\n"));
...
//            InputStream pdfImage;
            ...
            ResultSet rs = st.executeQuery("select* from properties where propertyStatus = 'reported' AND categoryID = '3'");
            while (rs.next()) {
